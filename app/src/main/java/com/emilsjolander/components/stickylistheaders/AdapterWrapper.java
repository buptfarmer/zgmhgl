...
public class AdapterWrapper extends BaseAdapter implements StickyListHeadersAdapter {
	...
	/**
	 * Will recycle header from {@link com.emilsjolander.components.stickylistheaders.WrapperView} if it exists
	 */
	 ...
	 * {@link com.emilsjolander.components.stickylistheaders.WrapperView} and will also recycle the divider if it exists.
	 */
